...
export default function HomeSearch() {
  ...
  return (
    <>
        <form onSubmit={handleSubmit} className="flex w-full mt5-5 mx-auto max-w-[90%] border border-gray-200 px-5 py-3 rounded-full hover:shadow-md focus:within:shadow-md transition-shadow sm:max-w-xl lg:max-w-2xl ">
        ...
        <div className="flex flex-col space-y-2 sm:space-y-0 sm:space-x-4 justify-center sm:flex-row mt-6">
            ...
            {randomSearchLoading ? ( <Image src="/spinner.svg" alt="loading..." width="50" height="50" className="h-6 text-center" /> ) : ( "I am Feeling Lucky" ) } </button>
